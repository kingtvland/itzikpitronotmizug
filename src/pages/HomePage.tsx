...
import { Wrench, Fan, Thermometer, Snowflake, ShoppingBag, Clipboard, Calendar } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section id="admin-link" className="py-20">
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center text-center mb-14 space-y-3">
              <div className="inline-flex items-center rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-sm text-primary">
              ...
              <h2 className="text-3xl md:text-4xl font-bold">מערכת ניהול לקוחות</h2>
              <p className="text-muted-foreground max-w-2xl">
                גישה למערכת ניהול הלקוחות והזמנות עבודה - לשימוש מנהלים בלבד
              </p>
